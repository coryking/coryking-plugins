...
| `chat-mining-methodology.md` | The search→quote research loop for mining Claude Code chat logs. Derived from field observations across 12 subagents. Documents what separates good from mediocre researchers, failure modes, and how cc-explorer MCP tools map to the loop. |
